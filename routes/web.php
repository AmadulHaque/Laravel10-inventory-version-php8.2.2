...
// });
 ...
 Route::middleware('auth')->group(function(){
  ...
  Route::controller(ExpenseTypeController::class)->group(function () {
    Route::get('/expense-type','ExpenseTypeAll')->name('ExpenseTypeAll');
    Route::post('/expense-type/store','ExpenseTypeStore')->name('ExpenseTypeStore');
    Route::get('/expense-type/edit/{id}','ExpenseTypeEdit')->name('ExpenseTypeEdit');
    Route::post('/expense-type/update','ExpenseTypeUpdate')->name('ExpenseTypeUpdate');
    Route::get('/expense-type/remove/{id}','ExpenseTypeRemove')->name('ExpenseTypeRemove');
  });

  Route::controller(ExpenseController::class)->group(function () {
    Route::get('/expense','ExpenseAll')->name('ExpenseAll');
    Route::post('/expense/store','ExpenseStore')->name('ExpenseStore');
    Route::get('/expense/edit/{id}','ExpenseEdit')->name('ExpenseEdit');
    Route::post('/expense/update','ExpenseUpdate')->name('ExpenseUpdate');
    Route::get('/expense/remove/{id}','ExpenseRemove')->name('ExpenseRemove');
  });
