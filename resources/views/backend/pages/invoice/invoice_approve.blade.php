   ...
   <div class="col-12">
     <div class="card">
       <div class="card-body">
         ...
         <a href="{{ route('InvoicePendinglist') }}" class="btn btn-primary mb-3" style="float:right;">
         ...
         <table class="table table-dark" width="100%">
           <tbody>
             <tr>
               ...
               <td>
                 <p> Name: <strong> {{ $payment['customer']['name']  }} </strong>
                 </p>
               </td>
               <td>
                 <p> Mobile: <strong> {{ $payment['customer']['mobile_no']  }} </strong>
                 </p>
               </td>
               <td>
                 <p> Email: <strong> {{ $payment['customer']['email']  }} </strong>
                 </p>
               </td>
             </tr>
             <tr>
         ...
         <form method="post" action="{{route('ApprovalStore',$invoice->id)}}"> @csrf <table border="1" class="table table-dark" width="100%">
             <thead>
               <tr>
             ...
             <tbody> @php $total_sum = '0'; @endphp @foreach($invoice['invoice_details'] as $key => $details) <tr>
