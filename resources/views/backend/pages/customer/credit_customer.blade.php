...
<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
  ...
  <div class="ms-auto">
    <div class="btn-group">
      <a href="{{route('credit.customer.print.pdf')}}" target="_blank" class="btn btn-danger">Credit Customer Print <i class="lni lni-printer"></i> </a>
    </div>
  </div>
</div>
<!--end breadcrumb-->
...
<script>
  $(document).ready(function() {
    ...
    function tableData(page=1){
      ...
      $.ajax({
           type: 'get',
           url: "{{ url('/credit/customer') }}?page="+page,
           dataType: 'html',
           data: {
               search: search,
               perPage: perPage
