...
<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
  ...
  <div class="ms-auto">
    <div class="btn-group">
      <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addExpenseTypeModal">Add Expense <i class="lni lni-plus"></i></button>
    </div>
  </div>
</div>
<!--end breadcrumb-->
...
<!-- add modal -->
@include( 'backend.components.Expense.add')
<!-- Modal -->
